...
const navigation: readonly AppNavItem<EmployeeRole>[] = [
  ...
  { icon: <NavIcon path="M15 4a3 3 0 1 0-6 0 3 3 0 0 0 2 2.82V9H6a2 2 0 0 0-2 2v2.18A3 3 0 1 0 6 13v-2h5v2.18a3 3 0 1 0 2 0V11h5v2.18a3 3 0 1 0 2 0V11a2 2 0 0 0-2-2h-5V6.82A3 3 0 0 0 15 4Z" />, label: 'Organization', path: '/organization' },
