...
export const OrganizationPage = () => {
  ...
  return <Stack spacing={1.25}>
    ...
    <Paper elevation={0} sx={{ alignItems: 'center', border: '1px solid #dfe7e1', borderRadius: 2.5, boxShadow: '0 7px 20px rgba(30,65,42,.055)', display: 'flex', flexWrap: 'wrap', gap: { xs: 3, sm: 5.5 }, px: 2.2, py: 1.7 }}><Box sx={{ alignItems: 'center', bgcolor: '#e2efe6', borderRadius: 1.7, color: '#39704a', display: 'flex', p: 1 }}><TreeIcon /></Box><Box><Typography sx={{ fontSize: '1.72rem', fontWeight: 900, letterSpacing: '-.045em', lineHeight: .92 }}>{employees.length}</Typography><Typography color="text.secondary" sx={{ fontSize: '.68rem', mt: .5 }}>People</Typography></Box><Box><Typography sx={{ color: '#386b49', fontSize: '1.72rem', fontWeight: 900, letterSpacing: '-.045em', lineHeight: .92 }}>{managerIds.length}</Typography><Typography color="text.secondary" sx={{ fontSize: '.68rem', mt: .5 }}><Box component="span" sx={{ display: { xs: 'inline', sm: 'none' } }}>Manager</Box><Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>People managers</Box></Typography></Box><Box><Typography sx={{ color: '#466d99', fontSize: '1.72rem', fontWeight: 900, letterSpacing: '-.045em', lineHeight: .92 }}>{departmentCount}</Typography><Typography color="text.secondary" sx={{ fontSize: '.68rem', mt: .5 }}><Box component="span" sx={{ display: 'inline', '@media (max-width: 320px)': { display: 'none' } }}>Departments</Box><Box component="span" sx={{ display: 'none', '@media (max-width: 320px)': { display: 'inline' } }}>Dept.</Box></Typography></Box><Box sx={{ ml: { sm: 'auto' } }}><Typography color="text.secondary" sx={{ fontSize: '.7rem' }}><Box component="span" sx={{ color: '#45a064' }}>●</Box> Active&nbsp;&nbsp; <Box component="span" sx={{ color: '#cc5b5b' }}>●</Box> Inactive</Typography></Box></Paper>
